namespace System.ComponentModel.Messaging.Server
{
    ...
    public class MessagePipeline : IMessagePipeline
    {
        ...
        /// </remarks>
        public virtual void Execute<TCommand>(TCommand command, IMessageProcessor processor) where TCommand : class, IMessage           
        {
            if (processor == null)
            {
        ...
        /// </remarks>
        public virtual TResponse Execute<TRequest, TResponse>(TRequest request, Func<TRequest, TResponse> query)
