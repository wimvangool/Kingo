...
namespace System.ComponentModel.Server.Caching
{
        ...
        where TMessageOut : class, IMessage<TMessageOut>
    {
        ...
        private readonly IQueryCacheProvider _cacheManager;
        ...
        /// </exception>        
        public QueryCacheModule(IQuery<TMessageIn, TMessageOut> query, QueryExecutionOptions options, IQueryCacheProvider cacheManager)
        {
            if (query == null)
            {
        ...
        /// </summary>
        protected virtual IQueryCacheProvider CacheManager
        {
