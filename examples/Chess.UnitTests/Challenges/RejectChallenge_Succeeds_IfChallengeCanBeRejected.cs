...
{
    [TestClass]
    public sealed class RejectChallenge_Succeeds_IfChallengeCanBeRejected : UnitTest<RejectChallengeCommand>
    {
        public readonly PlayerIsChallengedScenario PlayerIsChallenged;

        public RejectChallenge_Succeeds_IfChallengeCanBeRejected()
        {
