...
namespace Kingo.Samples.Chess.Games
{
    ...
    {                
        ...
        private bool IsNotPieceOfSameColor(ChessPiece piece)
        {
            return piece == null || !piece.HasColor(Color);
        }

        public virtual ChessPiece RemainInPlace()
        {
            return this;
        }

        public virtual ChessPiece ApplyMove(Move move)
        {
            return this;
        }
        ...
        public virtual ChessPiece ApplyPromotion(TypeOfPiece promoteTo)
        {
            throw NewUnsupportedPromotionException();
        }
