...
namespace Kingo.BuildingBlocks.ComponentModel.Server
{
    ...
    public sealed class MessageHandlerInstanceTest
    {
        ...
        [MultiValue(1)]
        [MultiValue(2)]
        private sealed class MessageHandlerWithAttributes : IMessageHandler<CommandStub>, IMessageHandler<object>
        {
            [SingleValue(2)]
            [MultiValue(3)]
            [MultiValue(4)]
            public Task HandleAsync(CommandStub message)
            {
        ...
        {
            var instance = new MessageHandlerInstance<CommandStub>(_handler);
