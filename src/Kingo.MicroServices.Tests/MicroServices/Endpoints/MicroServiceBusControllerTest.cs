...
//            public override IEnumerable<IEventHandlerEndpoint> CreateEventHandlerEndpoints() =>
//                Enumerable.Repeat(new Mock<IEventHandlerEndpoint>().Object, _numberOfEndpoints);
//        }
