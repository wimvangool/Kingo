...
namespace Kingo.MicroServices.Controllers
{
        ...
        where TRequest : new()
    {
        ...
        public QueryOperationTestDelegate<TRequest, TResponse> Given(Func<IMessageHandlerOperationTestProcessor, MicroProcessorOperationTestContext, Task> givenStatement)
        {
        ...
        private Func<IQueryOperationTestProcessor<TRequest, TResponse>, MicroProcessorOperationTestContext, Task> _whenStatement;

        public QueryOperationTestDelegate<TRequest, TResponse> When(Func<IQueryOperationTestProcessor<TRequest, TResponse>, MicroProcessorOperationTestContext, Task> whenStatement)
        {
            _whenStatement = whenStatement ?? throw new ArgumentNullException(nameof(whenStatement));
            return this;
        }

        protected override Task WhenAsync(IQueryOperationTestProcessor<TRequest, TResponse> processor, MicroProcessorOperationTestContext context) =>
