...
namespace Kingo.SharpDX
{
    ...
    /// </summary>
    [Serializable]
    public struct Angle : IEquatable<Angle>, IComparable<Angle>, IComparable, IAngle
    {
        /// <summary>
        ...
        private const float _RadiansToDegreesFactor = 180f;
        private readonly float _radiansFactor;

        private Angle(float radiansFactor)
        {
        ...
        {
            return new Angle(_radiansFactor % 2f);
        }
        ...
        {
            return (float) (_radiansFactor * Math.PI);
        }
