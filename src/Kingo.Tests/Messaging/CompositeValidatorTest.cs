...
namespace Kingo.Messaging
{
    ...
    public sealed class CompositeValidatorTest
    {
        ...
        {
            IMessageValidator left = null;
            IMessageValidator right = new NullValidator();
        ...
        {
            IMessageValidator left = new NullValidator();
            IMessageValidator right = null;
        ...
        private sealed class ValidatorStub : IMessageValidator
        {
