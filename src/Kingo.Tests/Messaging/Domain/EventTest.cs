...
namespace Kingo.Messaging.Domain
{
    ...
    public sealed class EventTest
    {
        ...
        private sealed class EventWithNoAttributes : Event<Guid, int> { }

        private sealed class EventWithTooManyAttributes : Event<Guid, int>
        {
            [AggregateId]
            public Guid Id1
            {
        ...
        private sealed class EventWithAttributesOnIndexer : Event<Guid, int>
        {
            [AggregateId]
        ...
        private sealed class EventWithWrongPropertyTypes : Event<Guid, int>
        {
            [AggregateId]
            public object Id
            {
        ...
        private sealed class EventWithNoGetters : Event<Guid, int>
        {
            [AggregateId]
            public Guid Id
            {
        ...
        private sealed class EventWithNoSetters : Event<Guid, int>
        {
            [AggregateId]
            public Guid Id
            {
        ...
        private sealed class EventWithPublicGettersAndSetters : Event<Guid, int>
        {
            [AggregateId]
            public Guid Id
            {
        ...
        private sealed class EventWithPublicGettersAndPrivateSetters : Event<Guid, int>
        {
        ...
        private static Guid GetAggregateId(IEvent<Guid, int> @event) =>
            @event.AggregateId;

        private static void SetAggregateId(IEvent<Guid, int> @event, Guid value) =>
            @event.AggregateId = value;

        private static int GetAggregateVersion(IEvent<Guid, int> @event) =>
            @event.AggregateVersion;

        private static void SetAggregateVersion(IEvent<Guid, int> @event, int version) =>
