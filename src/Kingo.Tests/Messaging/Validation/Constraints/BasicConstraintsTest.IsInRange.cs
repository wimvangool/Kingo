...
namespace Kingo.Messaging.Validation.Constraints
{
    public sealed partial class BasicConstraintsTest
    {
        ...
        public void ValidateIsNotInRange_ReturnsDefaultError_IfMemberIsInSpecifiedRange_And_NoErrorMessageIsSpecified()
        {
            ...
            validator.Validate(message).AssertMemberError(string.Format("Member ({0}) must not be within the following range: [0, 1000>.", member));
        }
        ...
        public void ValidateIsInRange_ReturnsDefaultError_IfMemberIsNotInSpecifiedRange_And_NoErrorMessageIsSpecified()
        {
            ...
            validator.Validate(message).AssertMemberError(string.Format("Member ({0}) must be within the following range: [1000, 2000>.", member));
        }
