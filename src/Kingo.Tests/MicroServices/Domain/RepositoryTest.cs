...
//            public Task HandleAsync(DoSomethingCommand message, MessageHandlerContext context) =>
...
//        private static void AssertEvent<TEvent>(MessageStream stream, int index, Action<TEvent> assert) =>
