...
//        {
//            await _processor.HandleAsync(null as object);
//        }        
...
//                context.EventBus.Publish(messageOut);
...
//                context.EventBus.Publish(messageOutA);

//            }).Append(messageInB, (message, context) =>
//            {
//                Assert.AreSame(messageInB, message);

//                context.EventBus.Publish(messageOutB);
//            });
...
//        [MessageHandler(ServiceLifetime.Scoped, MicroProcessorOperationTypes.InputMessage | MicroProcessorOperationTypes.OutputMessage)]
...
//        [MessageHandler(ServiceLifetime.Scoped, MicroProcessorOperationTypes.All)]
...
//        [MessageHandler(ServiceLifetime.Scoped, MicroProcessorOperationTypes.InputMessage)]
...
//        [MessageHandler(ServiceLifetime.Scoped, MicroProcessorOperationTypes.OutputMessage)]
...
//            var unitOfWork = new UnitOfWorkResourceManagerSpy(true);        
...
//        private sealed class SomeInternalProcessorException : MessageHandlerException { }
...
//                context.EventBus.Publish(someCommand);
//            });
...
//            var unitOfWork = new UnitOfWorkResourceManagerSpy(true, concurrencyException);
...
//            var someCommand = new SomeCommand();
//            var randomException = new Exception();
//            var unitOfWork = new UnitOfWorkResourceManagerSpy(true, randomException);
