...
namespace Kingo.MicroServices.TestEngine
{
	...
	public interface IWhenMessageState<TMessage>
    {
        /// <summary>
        ...
        /// </exception>
        IMessageHandlerTestRunner<TMessage> IsExecutedBy<TMessageHandler>(Action<MessageHandlerTestOperationInfo<TMessage>, MicroProcessorTestContext> configurator)
        ...
        /// The test-engine is not in a state where it can perform this operation.
        /// </exception>
        IMessageHandlerTestRunner<TMessage> IsHandledBy<TMessageHandler>(Action<MessageHandlerTestOperationInfo<TMessage>, MicroProcessorTestContext> configurator)
            where TMessageHandler : class, IMessageHandler<TMessage>;
    }
}
