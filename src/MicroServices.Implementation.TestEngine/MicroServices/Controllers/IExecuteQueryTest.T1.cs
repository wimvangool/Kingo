...
namespace Kingo.MicroServices.Controllers
{
    ...
    public interface IExecuteQueryTest<TResponse> : IMicroProcessorOperationTest
    {
        /// <summary>
        ...
        Task WhenAsync(IQueryProcessor<TResponse> processor, MicroProcessorOperationTestContext context);
        ...
        /// <param name="context">The context in which the test is running.</param>
        void Then(IExecuteQueryResult<TResponse> result, MicroProcessorOperationTestContext context);
    }
}
