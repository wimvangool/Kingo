...
namespace Kingo.MicroServices.Controllers
{
    ...
    public interface IExecuteQueryTest<TRequest, TResponse> : IMicroProcessorOperationTest
    {
        /// <summary>
        ...
        Task WhenAsync(IQueryProcessor<TRequest, TResponse> processor, MicroProcessorOperationTestContext context);
        ...
        /// <param name="context">The context in which the test is running.</param>
        void Then(TRequest request, IExecuteQueryResult<TResponse> result, MicroProcessorOperationTestContext context);
    }
}
