...
namespace Kingo
{
    ...
    public static class TypeExtensions
    {
        ...
        {
            return TryGetBinaryOperator(type, "op_Equality", out equalityOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_Inequality", out inequalityOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_LessThan", out lessThanOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_LessThanOrEqual", out lessThanOrEqualOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_GreaterThan", out greaterThanOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_GreaterThanOrEqual", out greaterThanOrEqualOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_Addition", out additionOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_Subtraction", out subtractiontOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_Multiply", out multiplyOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_Division", out divisionOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_Modulus", out modulusOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_ExclusiveOr", out exclusiveOrOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_BitwiseAnd", out bitwiseAndOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_BitwiseOr", out bitwiseOrOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_LeftShift", out leftShiftOperator);
        }
        ...
        {
            return TryGetBinaryOperator(type, "op_RightShift", out rightShiftOperator);
        }
        ...
        {
            return TryGetUnaryOperator(type, "op_UnaryPlus", out unaryPlusOperator);
        }
        ...
        {
            return TryGetUnaryOperator(type, "op_UnaryNegation", out unaryNegationtOperator);
        }
        ...
        {
            return TryGetUnaryOperator(type, "op_LogicalNot", out logicalNotOperator);
        }
        ...
        {
            return TryGetUnaryOperator(type, "op_OnesComplement", out onesComplementOperator);
        }
        ...
        {
            return TryGetUnaryOperator(type, "op_True", out trueOperator);
        }
        ...
        {
            return TryGetUnaryOperator(type, "op_False", out falseOperator);
        }
        ...
        {
            return TryGetUnaryOperator(type, "op_Implicit", out implicitOperator);
        }
        ...
        {
            return TryGetUnaryOperator(type, "op_Explicit", out explicitOperator);
        }
        ...
        {
            return method.IsSpecialName && method.Name == name && method.ReturnType == returnType;
        }
