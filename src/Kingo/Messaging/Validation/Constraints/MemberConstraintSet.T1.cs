...
namespace Kingo.Messaging.Validation.Constraints
{
    ...
    {        
        ...
        private sealed class ChildConstraintSet<TOriginal, TResult> : IErrorMessageWriter<TOriginal>, IMemberConstraintSet<TResult>
        {
            ...
            public bool WriteErrorMessages(TOriginal instance, IErrorMessageReader reader, bool haltOnFirstError)
            {
                _instance = instance;
        ...
        /// <inheritdoc />
        public bool WriteErrorMessages(T instance, IErrorMessageReader reader, bool haltOnFirstError = false)
        {
            if (reader == null)
            {
