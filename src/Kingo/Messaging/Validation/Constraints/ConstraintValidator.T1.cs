...
namespace Kingo.Messaging.Validation.Constraints
{
    ...
    /// </summary>    
    public class ConstraintMessageValidator<TMessage> : MemberConstraintSet<TMessage>, IMessageValidator<TMessage> where TMessage : class
    {                
        ...
        public ConstraintMessageValidator(IFormatProvider formatProvider = null)           
        {                                  
