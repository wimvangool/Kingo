...
namespace Kingo.MicroServices
{
    ...
    public sealed class QueryDecorator<TRequest, TResponse> : Query<TResponse>
    {
        ...
        private sealed class ExecuteAsyncMethod : MessageHandlerOrQueryMethod<ExecuteAsyncResult<TResponse>>
        {
            ...
            public override async Task<ExecuteAsyncResult<TResponse>> InvokeAsync() =>
        ...
        internal QueryDecorator(IQuery<TRequest, TResponse> query, TRequest message, QueryContext context)            
        {
            ...
            _method = new ExecuteAsyncMethod(query, message, context, MethodAttributeProvider.FromQuery(query));
        }
