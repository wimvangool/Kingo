...
{
    /// <summary>
    /// When implemented, represents and endpoint that connects to a service bus to publish specific messages.
    /// </summary>
    /// <typeparam name="TMessageEnvelope">Type of the messages that are sent to the service bus.</typeparam>
    public abstract class MicroServiceBusOutboundEndpoint<TMessageEnvelope> : MicroServiceBusEndpoint<TMessageEnvelope>, IMicroServiceBus
    {
        /// <inheritdoc />
