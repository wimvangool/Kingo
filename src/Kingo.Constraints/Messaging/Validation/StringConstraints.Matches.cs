...
namespace Kingo.Messaging.Validation
{
    ...
    public sealed class StringMatchesConstraint : Constraint<string>
    {
        ...
        /// <inheritdoc />
        public override IConstraintWithErrorMessage<string> Invert(StringTemplate errorMessage, Identifier name = null) => new ConstraintInverter<string>(this, ErrorMessages.StringConstraints_DoesNotMatch)
