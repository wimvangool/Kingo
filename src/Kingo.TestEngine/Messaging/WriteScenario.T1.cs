...
namespace Kingo.Messaging
{
    ...
    public abstract class WriteScenario<TMessage> : Scenario<IWriteScenarioResult>
    {
        #region [====== Executable ======]

        private sealed class Executable : ScenarioResult<IMessageStream>, IWriteScenarioResult
        {
            private readonly WriteScenario<TMessage> _scenario;

            public Executable(WriteScenario<TMessage> scenario)
            {
                _scenario = scenario;
            }                        
        ...
        internal override IWriteScenarioResult CreateResult() =>
            new Executable(this);
