...
{
    internal abstract class TestResult<TResult> : ITestResult
    {
        public async Task IsExceptionOfTypeAsync<TException>(Action<TException> assertCallback = null) where TException : MicroProcessorException
        {
