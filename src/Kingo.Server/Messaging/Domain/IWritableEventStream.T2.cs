...
{
    /// <summary>
    /// Represents a stream of <see cref="IHasKeyAndVersion{T, S}" /> that can be written to.
    /// </summary>
        ...
        where TVersion : struct, IEquatable<TVersion>, IComparable<TVersion>
    {
        ...
        /// </exception>
        void Write<TEvent>(TEvent @event) where TEvent : class, IHasKeyAndVersion<TKey, TVersion>, IMessage;
    }
}
