...
{
    [TestClass]
    public sealed class MessageHandlerTestBase_Fails_IfExceptionIsExpectedButAssertCallbackFails : MessageHandlerTestBaseTest<object>
    {        
        ...
        public override async Task ThenAsync()
        {
            ...
            try
            {
                await ThenResult().IsExceptionOfTypeAsync<InternalServerErrorException>(e =>
                {
